...
final class HuntZones
{
    ...
    public const REGIONS = [
        ...
        ['Newhaven', 32540, 32500], ['Aragonia', 33513, 32720],
        ['Laguna Islands', 32466, 32939], ['Elvenbane', 32590, 31645], ['Mistrock', 32560, 31449],
        ['Orc Fortress', 32934, 31781], ['Vengoth', 32916, 31516], ['Cyclopolis', 33251, 31698],
        ['Hero Cave', 33164, 31638], ['Stonehome', 33303, 31773], ['Grimvale', 33333, 31690],
        ['Oramond', 33501, 31965], ['Shadowthorn', 33075, 32170], ['Drefia', 33018, 32443],
        ...
        ['Hellgate', 32675, 31647], ['Nibelor', 32353, 31053], ['Helheim', 32473, 31174],
        ['Okolnir', 32230, 31412], ['Formorgar Glacier', 32102, 31144], ['Chyllfroest', 32060, 31034],
        ['Tyrsung', 32374, 31311], ['Grimlund', 32021, 31294], ['Inukaya', 32367, 31058],
        ['Senja', 32125, 31665], ['Vega', 31955, 31725], ['Isle of the Kings', 32173, 31938],
        ['Ghostlands', 32220, 31770], ['Fields of Glory', 32362, 31683], ['Mintwallin', 32540, 32200],
        ['Green Claw Swamp', 32820, 32020], ['Amazon Camp', 32839, 31920], ['Gnomebase Alpha', 33001, 31900],
        ['Meriana', 32340, 32580], ['Marapur', 33842, 32852], ['Murmuring Wilderness', 33690, 32780],
        ['Silvertides', 33776, 32842], ['Moonfall', 33807, 32745],
        ['Gnomprona', 33600, 32880], ['Zao', 33350, 31460], ['Razachai', 33074, 31100],
        ['Zzaion', 33316, 31558], ['Issavi', 33946, 31516], ['Warzones 4-6', 33844, 32214],
        ...
        ['Hive Outpost', 32163, 32838], ['Gray Island', 33191, 31985], ['Orcsoberfest', 33779, 31054],
        ['Ruins of Nuur', 33848, 31685], ['Island of Destiny', 32094, 32004], ['Targuna', 31950, 31897],
